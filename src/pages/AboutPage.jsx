  ...
  return (
    <div className={styles.pageWrapper}>
      ...
      <div className={styles.scrollContainer}>
        {/* Hero Section */}
        <section className={`${styles.heroSection} ${styles.scrollSection}`}>
        ...
        {/* Intro Section */}
        <section className={`${styles.introSection} ${styles.scrollSection}`}>
          ...
          <p className={styles.introDesc}>
            ...
            홍가영입니다.
            <br />
            소프트웨어콘텐츠학과를 전공하고 7년째 개인 블로그를 운영하며
            콘텐츠를 꾸준히 제작해왔습니다.
            <br />
        ...
        {/* About Section */}
        <section className={`${styles.aboutSection} ${styles.scrollSection}`}>
          ...
          <div className={styles.aboutList}>
            ...
            <div className={styles.aboutItem}>
              ...
              <p className={styles.aboutText}>
                ...
                <br />
                기능을 만드는 것보다 더 중요한 것은 그것이 어떻게 쓰일지
                고민하는 것입니다.
                <br />
